...
// GetToken getToken generates a JWT token for the user with the given userId and role.
...
func ExtractUserFromJWT(key string, r *http.Request) (string, string, error) {
